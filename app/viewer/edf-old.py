...
class PSGFeatureComputation:
    ...
    def run(self):
        ...
        self.spect(self.psds, self.freqs, 'PSG Spectrogram', 30, self.start_time, spectrogram_output)
...
if __name__ == "__main__":
    ...
    eeg_feature_computation = PSGFeatureComputation(edf_path, channels, stagepath, output_dir)
