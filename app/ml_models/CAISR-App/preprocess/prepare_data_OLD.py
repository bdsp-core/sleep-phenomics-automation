...
def standardize_channel_names(signal, verbose=False):
    ...
    # Standardize ECG, RAT, LAT, and SPO2 channel names
    signal.rename(columns={'ekg': 'ecg', 'ecg-la': 'ecg', 'ecg-v1': 'ecg',  'ecg l': 'ecg', 'ecgl': 'ecg', 
                        'sao2': 'spo2', 'osat': 'spo2', 'o2sat': 'spo2', 'o2 sat': 'spo2', 'o2-sat': 'spo2', 'o2-saturation': 'spo2',
                        'e2-m2': 'e2-m1', 'e1-m1': 'e1-m2',
                        'roc': 'e1-m2', 'loc': 'e2-m1',
                        'eog(l)': 'e1-m2', 'eog(r)': 'e2-m1',
                        'eog-l': 'e1-m2', 'eog-r': 'e2-m1',
                        'eog l': 'e1-m2', 'eog r': 'e2-m1',
                        'eog1': 'e1-m2', 'eog2': 'e2-m1',
                        'rt eye (e2)': 'e2-m1', 'lt eye (e1)': 'e1-m2',
                        'heart rate': 'hr', 'heartrate': 'hr', 'h.r.': 'hr',
                        'f3m2': 'f3-m2', 'f4m1': 'f4-m1', 'c3m2': 'c3-m2', 'c4m1': 'c4-m1', 'o1m2': 'o1-m2', 'o2m1': 'o2-m1',
                        'e1m2': 'e1-m2', 'e2m1': 'e2-m1', 
                        'f4-m1+m2': 'f4-m1', 'f3-m2+m1': 'f3-m2', 'c4-m1+m2': 'c4-m1', 'c3-m2+m1': 'c3-m2', 'o2-m1+m2': 'o2-m1', 'o1-m2+m1': 'o1-m2',
                        'chin1chin2': 'chin1-chin2', 'chin': 'chin1-chin2', 'chin_emg': 'chin1-chin2',
                        'emg.subm': 'chin1-chin2', 'emg': 'chin1-chin2', 'emg1': 'chin1-chin2', 'emg2': 'chin1-chin2',
                        'chin emg': 'chin1-chin2', 'chin_emg1': 'chin1-chin2', 'chin_emg2': 'chin1-chin2',
                        'l chin': 'chin 1', 'r chin': 'chin 2', 'chin1': 'chin 1', 'chin2': 'chin 2',
                        'abdomen': 'abd', 'thorax': 'chest', 'abdominal': 'abd', 'thoracic': 'chest', 'thor res': 'chest', 'abd res': 'abd',
                        'abdo res': 'abd', 'chest res': 'chest', 'abdominal res': 'abd', 'thoracic res': 'chest',
                        'abdo': 'abd', 'thor': 'chest',
                        'npt': 'ptaf', 'nptaf': 'ptaf', 'pap': 'ptaf', 'pap flow': 'ptaf', 'papflow': 'ptaf', 'nasal_pressure': 'ptaf', 'nasal': 'ptaf',
                        'cannula_flow': 'ptaf', 'flow': 'airflow', 'air flow': 'airflow', 'thermal airflow': 'airflow', 'airflow thermal': 'airflow',
                        'c press': 'cpres', 'c_press': 'cpres', 'cpap pressure': 'cpres', 'cpap': 'cpres', 'cpap_press': 'cpres', 'cpap_press': 'cpres',
                        'a1': 'm1', 'a2': 'm2',
...
def process_files(path_dir_input, path_dir_output, autoscale_signals=True, overwrite=False, verbose=False):
    ...
    print(f"{len(files_done)} files already processed.")
    ...
    # Determine which files still need to be processed
        ...
        to_process = fileids
        print(f"'Overwrite' is set to True. All files will be processed.")
